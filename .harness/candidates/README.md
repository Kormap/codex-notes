...
실행 모드 라우팅 Candidate A의 기각 기록은 [cd-20260912-execution-mode-routing-01.md](cd-20260912-execution-mode-routing-01.md)에서 확인한다.
현재 활성 baseline으로 승격한 Candidate A2는 [cd-20260912-execution-mode-routing-02.md](cd-20260912-execution-mode-routing-02.md)에서 확인한다.
