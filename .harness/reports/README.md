...
현재 실행 모드 라우팅 baseline 준비도 집계는 [rp-20260911-execution-mode-routing-baseline-01.md](rp-20260911-execution-mode-routing-baseline-01.md)에서 확인한다.
현재 실행 모드 라우팅 baseline 재실행 집계는 [rp-20260912-execution-mode-routing-baseline-01.md](rp-20260912-execution-mode-routing-baseline-01.md)에서 확인한다.
현재 실행 모드 라우팅 Candidate A2 baseline 재평가 집계는 [rp-20260912-execution-mode-routing-a2-baseline-01.md](rp-20260912-execution-mode-routing-a2-baseline-01.md)에서 확인한다.
